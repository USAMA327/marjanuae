  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 flex justify-between  px-2 sm:px-10  py-1.5">
      <div className="flex space-x-5 text-white">
        ...
        >
          <Icon icon="fluent-color:phone-16" className="text-lg " />
          <p className=" hover:text-orange-400   text-xs md:text-sm">
        ...
        <a
          ...
          className=" text-sm flex items-center gap-1"
        >
          <Icon icon="material-icon-theme:email" className="text-lg " />
          <p className=" hover:text-orange-400  text-xs md:text-sm">
      ...
      <a
        ...
        target="_blank"
        className="group flex items-center  text-white  space-x-2 cursor-pointer"
      >
        ...
        <div className="hidden md:block group-hover:text-green-500">
          ...
          <p className="font-semibold text-sm  group-hover:text-orange-400 ">
