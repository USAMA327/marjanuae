  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 flex flex-col pt-32 items-center">
     <HelpSection/>
      ...
      <h1 className="text-2xl font-semibold text-primary bg-[#1572D310]  px-4 py-3 rounded-sm mb-4 text-center">Frequently Asked Questions</h1>
          ...
          {faqs.map((faq, index) => (
            <div key={index} className="border-b pb-2">
              <button
                ...
                className="w-full flex justify-between items-center text-lg font-semibold text-gray-800 py-3 focus:outline-none"
              >
