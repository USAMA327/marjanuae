      ...
      <div className=" pt-28 pb-10  px-2 md:px-16  bg-soft-gray-blue text-black">
        <div className="flex flex-col lg:flex-row justify-between  py-10 ">
          <div className="flex text-center lg:text-left w-full lg:w-[50%] flex-col justify-center mb-5  ">
            <h1 className="font-bold  text-4xl md:text-5xl  mb-2 md:mb-4 font-serif  text-primary ">
              AL MARJAN
            </h1>
          ...
          <div className="relative   lg:mx-10 w-full lg:w-[50%]    text-primary ">
            <h3 className="text-8xl md:text-9xl font-semibold   text-center font-serif  ">
              DUBAI
            </h3>
            <Image
